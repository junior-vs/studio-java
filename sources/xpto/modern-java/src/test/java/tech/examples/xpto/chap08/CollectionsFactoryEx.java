package tech.examples.xpto.chap08;
...
public class CollectionsFactoryEx {

  @Test
  void testCreatList(){

    List<String> friends = List.of("Joe", "Ross", "Phoebe");
    Assertions.assertEquals("[Joe, Ross, Phoebe]", friends.toString());
    Assertions.assertThrows(
        UnsupportedOperationException .class, () -> friends.add("Maria"));
  }
